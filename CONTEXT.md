...
**Service**:
A Sanity CMS document holding editorial prose and image for a Class, or for the non-bookable pages (coaching, community, private). Purely editorial — no title, slug or price of its own — matched to its Class by `classSlug`.
